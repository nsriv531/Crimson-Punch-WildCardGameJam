...
public class PlayerMovement : MonoBehaviour {
    ...
    void Update()
    {
        ...
        sprinting = !PauseMenu.IsOpen && Input.GetKey(KeyCode.LeftShift) && IsGrounded() && (Input.GetAxisRaw("Vertical") > 0);
        if (sprinting)
        {
    ...
    void Movement()
    {
        var fwd = Mathf.Max(Input.GetAxisRaw("Vertical"), PauseMenu.IsOpen? 1.0f : -1.0f);
